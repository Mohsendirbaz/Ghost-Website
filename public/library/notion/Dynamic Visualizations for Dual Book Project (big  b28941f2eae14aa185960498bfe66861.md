# Dynamic Visualizations for Dual Book Project (big picture themes)

## 📚 PROJECT STRUCTURE OVERVIEW

```mermaid
graph TB
    subgraph Climate["📗 PROSECUTING INEQUITY (Climate)"]
    ...
    subgraph AI["📘 DISHONEST AI IS DANGEROUS AI"]
...
graph LR
    ...
    subgraph AI_Chapters["AI Ethics Book"]
        AC1[Ch 1: AI Increasing Relevance]
...
graph TD
    ...
    subgraph AI_Critical["AI Ethics - CRITICAL Chapters"]
        A1[Ch 1: AI Increasing Relevance]
        A3[Ch 3: Bias]
        A4[Ch 4: Governance]
        A5[Ch 5: Privacy]
...
```mermaid
graph TD
    Start[⚙️ Technical Specialist Path]
    ...
    subgraph Tech_AI["AI Ethics - Technical Focus"]
        TA1[Ch 1: AI increase Relevance]
        TA3[Ch 3: Bias]
        TA4[Ch 4: Governance]
        TA5[Ch 5: Privacy]
        TA7[Ch 7: Labor]
...
```mermaid
graph TD
    Start[📚 Student Path - Foundational]
...
**END OF DYNAMIC VISUALIZATIONS**

*Import these diagrams into Obsidian or Notion for interactive navigation*