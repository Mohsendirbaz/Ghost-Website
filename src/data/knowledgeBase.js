...
export const KB_PARTS = [
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
        ...
        number: 'III',
        pageStart: 49,
        title: { en: 'Strategic Partnerships', fa: 'مشارکت‌های استراتژیک' },
        description: {
            en: 'Partnership model and collaboration areas: how Ghost Autonomy engages semiconductor, automotive, and academic partners. Country-level strategy analysis has been retired from the public documentation.',
            fa: 'مدل مشارکت و حوزه‌های همکاری: نحوه تعامل Ghost Autonomy با شرکای نیمه‌هادی، خودروسازی و دانشگاهی. تحلیل راهبردی در سطح کشورها از مستندات عمومی کنار گذاشته شده است.',
        },
        ...
        chapters: [
            {
                ...
                title: { en: 'Partnership Model', fa: 'مدل مشارکت' },
                description: { en: 'The structural-complementarity principle: partners are selected where capabilities complement the architecture — fabrication, automotive integration, and academic research.', fa: 'اصل مکمل‌بودن ساختاری: شرکا در حوزه‌هایی انتخاب می‌شوند که توانمندی‌هایشان مکمل معماری باشد — ساخت، یکپارچه‌سازی خودرویی و پژوهش دانشگاهی.' },
                tags: ['strategy'],
                sections: [
                    { id: 'sec-9-1', slug: 'strategic-asset-definition', number: '9.1', pageStart: 51, title: { en: 'What Counts as a Strategic Asset', fa: 'دارایی استراتژیک چیست' }, tags: ['strategy'], subsections: [] },
                    { id: 'sec-9-2', slug: 'global-partner-landscape', number: '9.2', pageStart: 53, title: { en: 'Partner Categories', fa: 'دسته‌بندی شرکا' }, tags: ['strategy'], subsections: [] },
                ],
            },
            {
                id: 'ch-10', slug: 'collaboration-areas', number: '10', pageStart: 57,
                title: { en: 'Collaboration Areas', fa: 'حوزه‌های همکاری' },
                description: { en: 'Fabrication and packaging, OEM integration pilots, and academic research collaborations — described at the category level; specific engagements are disclosed when formalized.', fa: 'ساخت و بسته‌بندی، پایلوت‌های یکپارچه‌سازی با خودروسازان، و همکاری‌های پژوهشی دانشگاهی — در سطح دسته‌بندی توصیف شده‌اند؛ همکاری‌های مشخص پس از رسمی‌شدن اعلام می‌شوند.' },
                tags: ['partnerships'],
                sections: [],
            },
        ],
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
        ...
        description: {
            en: 'ISA conformance testing, benchmark suite, comparative analysis, emulation and simulation results, safety validation, and system integration. Evidentiary standing is preserved throughout: figures are labeled measured, projected, or planned — projected and planned items are design targets, not demonstrated results.',
            fa: 'آزمون انطباق ISA، مجموعه بنچمارک، تحلیل مقایسه‌ای، نتایج شبیه‌سازی و امولاسیون، اعتبارسنجی ایمنی و یکپارچه‌سازی سامانه. جایگاه شواهد در سراسر متن حفظ شده است: ارقام با برچسب اندازه‌گیری‌شده، پیش‌بینی‌شده یا برنامه‌ریزی‌شده مشخص می‌شوند — موارد پیش‌بینی‌شده و برنامه‌ریزی‌شده هدف طراحی‌اند، نه نتایج اثبات‌شده.',
        },
        ...
        chapters: [
            ...
            },
            {
                ...
                sections: [
                    { id: 'sec-39-1', slug: 'silicon-results', number: '39.1', pageStart: 201, title: { en: 'Silicon Results (Projected)', fa: 'نتایج سیلیکون (پیش‌بینی‌شده)' }, tags: ['validation', 'semiconductor'], subsections: [] },
                    ...
                    { id: 'sec-39-3', slug: 'field-validation', number: '39.3', pageStart: 203, title: { en: 'Field Validation (Planned)', fa: 'اعتبارسنجی میدانی (برنامه‌ریزی‌شده)' }, tags: ['validation'], subsections: [] },
            ...
            },
            {
                ...
                sections: [
                    { id: 'sec-41-1', slug: 'oem-integration-pilot', number: '41.1', pageStart: 211, title: { en: 'OEM Integration Pilot (Planned)', fa: 'پایلوت یکپارچه‌سازی OEM (برنامه‌ریزی‌شده)' }, tags: ['autonomous-driving'], subsections: [] },
                    ...
                    { id: 'sec-41-4', slug: 'customer-feedback', number: '41.4', pageStart: 214, title: { en: 'Design-Partner Feedback (Planned)', fa: 'بازخورد شرکای طراحی (برنامه‌ریزی‌شده)' }, tags: ['business'], subsections: [] },
                ],
            },
        ],
    },
