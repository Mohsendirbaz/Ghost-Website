...
\tcbuselibrary{breakable,skins,theorems,shadows}
\usepackage{framed}
...
% ===================== TIKZ STYLES =====================
\tikzstyle{pathway1}=[rectangle, draw=frameBlue, fill=primaryLight, text width=3cm, text centered, rounded corners, minimum height=1.2cm, line width=1pt, drop shadow={opacity=0.3}]
\tikzstyle{pathway2}=[rectangle, draw=frameOrange, fill=secondaryLight, text width=3cm, text centered, rounded corners, minimum height=1.2cm, line width=1pt, drop shadow={opacity=0.3}]
\tikzstyle{pathway3}=[rectangle, draw=frameGreen, fill=tertiaryLight, text width=3cm, text centered, rounded corners, minimum height=1.2cm, line width=1pt, drop shadow={opacity=0.3}]
\tikzstyle{pathway4}=[rectangle, draw=framePurple, fill=quaternaryLight, text width=3cm, text centered, rounded corners, minimum height=1.2cm, line width=1pt, drop shadow={opacity=0.3}]
...
{\color{accentColor}\rule{0.5\textwidth}{0.5pt}}
