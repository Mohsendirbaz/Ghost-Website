...
% ---------- Subtle depth (matches English template aesthetic) ----------
\tcbset{
  persianBoxShadow/.style={
    drop fuzzy shadow={shadow xshift=0.6mm, shadow yshift=-0.6mm, opacity=0.15}
  }
}
\usepackage{framed}
...
% ===================== TIKZ =====================
\usepackage{tikz}
\usetikzlibrary{shapes,arrows,positioning,calc,decorations.pathreplacing,shadows.blur,shadows}
...
% Spacing control (closer to English template rhythm)
\titlespacing*{\section}{0pt}{2.0ex plus 0.8ex minus 0.2ex}{0.9ex plus 0.2ex}
\titlespacing*{\subsection}{0pt}{1.6ex plus 0.6ex minus 0.2ex}{0.6ex plus 0.2ex}
\titlespacing*{\subsubsection}{0pt}{1.2ex plus 0.5ex minus 0.2ex}{0.4ex plus 0.2ex}
...
% Accent color (tuned for higher contrast against light backgrounds)
\definecolor{accentColor}{RGB}{120, 80, 80}

% Light background palette (clearer semantic names)
\definecolor{primaryLight}{RGB}{235, 242, 248}
\definecolor{secondaryLight}{RGB}{248, 243, 238}
\definecolor{tertiaryLight}{RGB}{238, 246, 240}
\definecolor{quaternaryLight}{RGB}{250, 248, 238}

% Backward-compatible aliases (legacy names used in earlier drafts)
\colorlet{pathwayIncome}{primaryLight}
\colorlet{pathwayEquity}{secondaryLight}
\colorlet{pathwayMarket}{tertiaryLight}
\colorlet{pathwayAssets}{quaternaryLight}
...
\newtcolorbox{keyconceptbox}[1][]{
  ...
  boxed title style={colback=headerColor, arc=4pt, size=small},
  boxrule=0.75pt,
  left=4mm,
  right=4mm,
  top=3mm,
...
% Research-style box (English template parity)
...
\vspace{0.6cm}
{\color{accentColor}\rule{0.7\textwidth}{0.75pt}}
\vspace{0.6cm}
...
\vspace{1cm}
{\color{accentColor}\rule{0.6\textwidth}{0.75pt}}
